...
public:
                        ...
                        int continuousDeliveryCardsCount, int codeReviewCardsCount, int refactoringCardsCount, int bonusCardsCount, int technicalDebtCardsCount)
    {
        ...
        UsefulCardsInHand = trainingCardsCount + codingCardsCount + dailyRoutineCardsCount + taskPrioritizationCardsCount + architectureStudyCardsCount + continuousDeliveryCardsCount + codeReviewCardsCount + refactoringCardsCount + bonusCardsCount;
    }
...
int main()
{
    ...
    while (1)
    {
        ...
        for (int i = 0; i < applications_count; i++)
        {
            ...
            cin >> object_type >> id >> training_needed >> coding_needed >> daily_routine_needed >> task_prioritization_needed >> architecture_study_needed >> continuous_delivery_needed >> code_review_needed >> refactoring_needed;
            cin.ignore();
        ...
        for (int i = 0; i < 2; i++)
        {
            ...
            cin >> player_location >> player_score >> player_permanent_daily_routine_cards >> player_permanent_architecture_study_cards;
            cin.ignore();
        ...
        for (int i = 0; i < card_locations_count; i++)
        {
            ...
            cin >> cards_location >> training_cards_count >> coding_cards_count >> daily_routine_cards_count >> task_prioritization_cards_count >> architecture_study_cards_count >> continuous_delivery_cards_count >> code_review_cards_count >> refactoring_cards_count >> bonus_cards_count >> technical_debt_cards_count;
            cin.ignore();
            ...
            if (cards_location == "HAND")
                ...
                me.UsefulCardsNotInHand += training_cards_count + coding_cards_count + daily_routine_cards_count + task_prioritization_cards_count + architecture_study_cards_count + continuous_delivery_cards_count + code_review_cards_count + refactoring_cards_count + bonus_cards_count;
        }
